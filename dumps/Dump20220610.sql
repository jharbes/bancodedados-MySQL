...
CREATE TABLE `gafanhotos` (
  ...
  `prof` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `gafanhotos` VALUES (NULL,1,'Godofredo','','1984-01-02','M',78.50,1.83,'Brasil'),(NULL,2,'Maria','','1999-12-30','F',55.20,1.65,'Portugal'),(NULL,3,'Creuza','','1920-12-30','F',50.20,1.65,'Brasil'),(NULL,4,'Adagilza','','1930-11-02','F',63.20,1.75,'Irlanda'),(NULL,5,'Cláudio','','1975-04-22','M',99.00,2.15,'Brasil'),(NULL,6,'Pedro','','1999-12-03','M',87.00,2.00,'Brasil'),(NULL,7,'Janaína','','1987-11-12','F',75.40,1.66,'EUA');
...
-- Dump completed on 2022-06-10 13:33:41
